...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooks.enterFirstName("Priya");
        laptopsAndNotebooks.enterLastName("Test");
        laptopsAndNotebooks.enterEmail("priyatest123@gmail.com");
        ...
        laptopsAndNotebooks.enterPostCode("NW12 1HA");
        laptopsAndNotebooks.selectCountry("United Kingdom");
        laptopsAndNotebooks.selectRegion("Hertfordshire");
        //2.21 Click on “Continue” Button
        laptopsAndNotebooks.clickOnGuestContinue();//2.22 Add Comments About your order into text area
